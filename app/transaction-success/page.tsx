          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-start justify-between pb-1.5 border-b border-gray-100">
              <div className="flex-1">
                ...
                <p className="text-xs font-semibold text-gray-900 break-all pr-2">{transaction.id || `TXN${Date.now()}`}</p>
              </div>
              <button
            ...
            {transaction.sessionId && (
              <div className="flex items-start justify-between pb-1.5 border-b border-gray-100">
                <div className="flex-1">
                  ...
                  <p className="text-xs font-semibold text-gray-900 break-all pr-2">{transaction.sessionId}</p>
                </div>
                <button
