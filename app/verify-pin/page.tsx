    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#0000FF" }}>
      ...
      <div className="flex-1 px-6 flex flex-col justify-center">
        <div className="text-center mb-8">
          <h2 className="text-white text-2xl font-bold mb-2">Enter Your PIN</h2>
        ...
        {/* Error Message */}
        {errorMessage && (
          <div className="bg-red-500/20 border border-red-500 rounded-lg p-4 text-center mb-8">
        ...
        <div className="flex justify-center items-center gap-8 max-w-xs mx-auto">
          <button
